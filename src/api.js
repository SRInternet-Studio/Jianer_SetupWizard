...
export const checkUpdate = () => api.get('/update/check').then(r => r.data)
export const executeUpdate = () => api.post('/update/execute').then(r => r.data)
export const updateProgress = (jobId) => api.get(`/update/progress/${jobId}`).then(r => r.data)
export const getUpdateMirror = () => api.get('/update/mirror').then(r => r.data)
export const setUpdateMirror = (payload) => api.post('/update/mirror', payload).then(r => r.data)
